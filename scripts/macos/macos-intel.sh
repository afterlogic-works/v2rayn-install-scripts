...
DMG_URL="https://github.com/2dust/v2rayN/releases/download/7.12.7/v2rayN-macos-64.dmg"
...
### Launch the app to generate configs
echo "Starting v2rayN to create configs..."
open -a "$APP_PATH"
...
### Close the app
echo "Closing v2rayN..."
# Attempt to close via AppleScript (can use killall if it doesn’t work)
